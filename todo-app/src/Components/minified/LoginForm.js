...
const useStyles = makeStyles((theme) => ({
  ...
  login: { display: "block" },
  loginbtn: { marginRight: 10, marginTop: 10, cursor: "pointer" },
  buttonSection: { background: "white", paddingTop: 75, paddingBottom: 70 },
  containerGrid: {
    height: "auto",
    width: "auto",
    padding: 100,
  ...
  grid: { display: "block", width: "auto", alignContent: "center" },
  input: {
    width: "100%",
    padding: "6px 12px",
    margin: "8px 0",
  ...
  title: {
    ...
    fontWeight: "bolder",
    fontSize: 28,
    [theme.breakpoints.up("md")]: { fontSize: 35 },
  },
  text: {
    color: "purple",
    fontSize: 18,
